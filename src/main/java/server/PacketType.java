...
public enum PacketType {
    ...
    GET_TRANSACTION, INCREASE_BANK_BALANCE, INCREASE_WALLET_BALANCE, DECREASE_WALLET_BALANCE, GET_ALL_PRODUCTS,
    EDIT_PRODUCT_REQUEST, GET_CATEGORY_BY_NAME, GET_PARENT_CATEGORIES, GET_ALL_REQUESTS, GET_PRODUCT_BY_ID, GET_SELLER_PRODUCTS, ADD_AUCTION_REQUEST, GET_AVAILABLE_AUCTION_PRODUCTS, GET_ALL_AUCTIONS, GET_ROOT_CATEGORIES,
