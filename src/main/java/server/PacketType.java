...
public enum PacketType {
    LOGIN, REGISTER, ADD_DISCOUNT_REQUEST, EDIT_DISCOUNT_REQUEST, REMOVE_DISCOUNT_REQUEST, EXIT,
    ...
    EDIT_PRODUCT_REQUEST, GET_CATEGORY_BY_NAME, GET_PARENT_CATEGORIES, GET_PRODUCT_BY_ID, GET_SELLER_PRODUCTS,
    ...
    GET_AVERAGE_PRICE, GET_PERSON_BY_TOKEN, GET_BANK_ID, GET_WALLET_BALANCE,GET_WALLET, GET_REQUESTS_OF_TYPE,
    ...
    ADD_TO_CART, OFFER_PRICE_FOR_AUCTION, SEND_AUCTION_MESSAGE, AUCTION_PURCHASE,
    GET_COUNT_IN_CART,SET_COUNT_IN_CART, GET_CART,
    ADD_FILE_REQUEST, ASK_FOR_FILE_REQUEST,BUY_FILE_REQUEST, GET_ALL_FILES,
    GET_FILE_PATH, FILE_WALLET_PURCHASE, FILE_BANK_PURCHASE,
    SUPPORT_CHAT_OPEN, SUPPORT_CHAT_SEND, PUBLIC_CHAT_SEND, CHANGE_INFO, GET_ALL_PERSON_INFO, REMOVE_USER, IS_ONLINE, GET_ALL_ONLINE_SUPPORTS, GET_ALL_CLIENTS_WITH_CHATS, SUPPORT_CHAT_BACK
}
