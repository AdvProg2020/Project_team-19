...
public class SalespersonProductMenu extends Menu {
    ...
    public Menu getAddProductMenu() {
        return new Menu("Add Product", this) {
            ...
            @Override
            public void execute() {
                System.out.println("if product exists enter the product's id else enter \"..\" to continue.");
                ...
                while ((category = CategoryController.getInstance().getCategoryByName(input = scanner.nextLine(), rootCategories)) == null
