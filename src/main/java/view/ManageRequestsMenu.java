...
public class ManageRequestsMenu extends Menu {
    ...
    private RequestController.FilterRequestType getRequestTypeByInput (String input) {
        if ("1".equals(input)) {
            return RequestController.FilterRequestType.ALL;
        } else if ("2".equals(input)) {
            return RequestController.FilterRequestType.SALESPERSON;
        } else if ("3".equals(input)) {
            return RequestController.FilterRequestType.PRODUCT;
        }
        return RequestController.FilterRequestType.DISCOUNT;
    }
